<?php get_header(); ?>
  ...
  ?>
  <section class="hero-post-wrap" style=" background-image: linear-gradient(rgba(0, 0, 0, 0.719),rgba(0, 0, 0, 0.418)) ,url(<?php echo get_the_post_thumbnail_url(); ?>); ">
    <div class="container-xl">
    <div class="hero-post-info">
      <div class="post-meta mb-3">
        <span><?php echo _e('New In Blog', 'borofpani'); ?></span>
      </div>
      <div class="post-meta mb-3">
  ...
  <?php 
      ...
      ?>
        <section class="hero-post-wrap" style=" background-image: linear-gradient(rgba(0, 0, 0, 0.719),rgba(0, 0, 0, 0.418)) ,url(<?php echo get_theme_mod('theme-banner', get_template_directory_uri().'/img/1.jpg' ) ?>); ">
          <div class="container-xl">
          <div class="hero-post-info">
            <p class="lead"><?php _e('Post Show From', 'borofpani'); ?> 
      "<?php 
        the_search_query();
      ?>"</p>
          </div>
  ...
  <section class="cat-list pt-5 text-center">
    <div class="container-xl">
      <h4 class=""><?php _e('Post Show From', 'borofpani'); ?> 
      "<?php 
        the_search_query();
      ?>"
      </h4>
