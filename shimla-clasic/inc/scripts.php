<?php
  ...
  //Shimla theme enqueue functions

  function shimla_stylesheets() {
  ...
  add_action('wp_enqueue_scripts', 'shimla_stylesheets');



  function shimla_scripts() {
  ...
  add_action('wp_enqueue_scripts', 'shimla_scripts');
